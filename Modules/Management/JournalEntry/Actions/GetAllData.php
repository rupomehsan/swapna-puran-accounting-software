...
namespace Modules\Management\JournalEntry\Actions;
...
class GetAllData
{
    ...
    $q->where('journal_id', 'like', '%' . $searchKey . '%');    

    $q->orWhere('account_id', 'like', '%' . $searchKey . '%');    

    $q->orWhere('entry_type', 'like', '%' . $searchKey . '%');    
