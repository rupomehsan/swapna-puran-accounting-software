/**
 * Journal Store - Factory Pattern Implementation
 *
...
// Create the Journal store with all CRUD functionality
export const journal_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = journal_store;
