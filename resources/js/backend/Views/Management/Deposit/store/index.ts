/**
 * Deposit Store - Factory Pattern Implementation
 *
...
// Create the Deposit store with all CRUD functionality
export const deposit_store = createCrudStore(setup);
