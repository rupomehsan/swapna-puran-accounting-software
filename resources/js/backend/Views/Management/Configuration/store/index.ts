/**
 * Configuration Store - Factory Pattern Implementation
 *
...
// Create the Configuration store with all CRUD functionality
export const configuration_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = configuration_store;
