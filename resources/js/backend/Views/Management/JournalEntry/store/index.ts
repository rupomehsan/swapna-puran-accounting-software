/**
 * JournalEntry Store - Factory Pattern Implementation
 *
...
// Create the JournalEntry store with all CRUD functionality
export const journal_entry_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = journal_entry_store;

// Default export for Composition API usage
export default journal_entry_store;
