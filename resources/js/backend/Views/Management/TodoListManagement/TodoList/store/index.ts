/**
 * TodoList Store - Factory Pattern Implementation
 *
...
// Create the TodoList store with all CRUD functionality
export const todo_list_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = todo_list_store;

// Default export for Composition API usage
export default todo_list_store;
