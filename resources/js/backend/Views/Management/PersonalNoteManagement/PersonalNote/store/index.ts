/**
 * PersonalNote Store - Factory Pattern Implementation
 *
 ...
 * @package PersonalNote
 */

import { createCrudStore } from "@/shared/store/createStore";
import setup from "../setup";

// Create the PersonalNote store with all CRUD functionality
export const personal_note_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = personal_note_store;

// Default export for Composition API usage
export default personal_note_store;
