/**
 * Due Store - Factory Pattern Implementation
 *
...
// Create the Due store with all CRUD functionality
export const due_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = due_store;

// Default export for Composition API usage
export default due_store;
