/**
 * Withdrawal Store - Factory Pattern Implementation
 *
...
// Create the Withdrawal store with all CRUD functionality
export const withdrawal_store = createCrudStore(setup);

// Backwards compatibility with legacy mapActions pattern
export const store = withdrawal_store;

// Default export for Composition API usage
export default withdrawal_store;
